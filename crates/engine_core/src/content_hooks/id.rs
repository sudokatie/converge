//! Typed identifiers for content hooks.

use serde::{Deserialize, Serialize};

macro_rules! define_hook_id {
...
define_hook_id!(ContentHookId, "hook");
define_hook_id!(EventId, "event");
define_hook_id!(ConditionId, "cond");
define_hook_id!(ActionId, "action");

#[cfg(test)]
mod tests {
    use super::*;

    macro_rules! test_hook_id {
    ...
    test_hook_id!(content_hook_id, ContentHookId, "hook");
    test_hook_id!(event_id, EventId, "event");
    test_hook_id!(condition_id, ConditionId, "cond");
    test_hook_id!(action_id, ActionId, "action");
}
