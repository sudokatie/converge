defmodule Converge.CRDT.LWWMapTest do
  ...
  test "merge takes newer value for same key" do
    ...
    a = %LWWMap{
      node_id: "node1",
      entries: %{
        "name" => %Converge.CRDT.LWWRegister{value: "old", timestamp: 100, node_id: "node1"}
      },
      tombstones: %{}
    }
    ...
    b = %LWWMap{
      node_id: "node2",
      entries: %{
        "name" => %Converge.CRDT.LWWRegister{value: "new", timestamp: 200, node_id: "node2"}
      },
      tombstones: %{}
    }
