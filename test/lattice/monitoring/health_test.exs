defmodule Lattice.Monitoring.HealthTest do
  use ExUnit.Case, async: false

  alias Lattice.Monitoring.Health
  ...
  describe "HTTP server" do
    setup do
      ...
      {:ok, metrics} = Lattice.Monitoring.Metrics.start_link([])
    ...
    test "responds to /metrics", %{port: port} do
      ...
      assert String.contains?(response, "200 OK")
      assert String.contains?(response, "# Lattice Metrics")
    end
