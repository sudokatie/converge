defmodule Converge.CLI.Main do
  @moduledoc """
  Main CLI entry point for Converge.
  """

  alias Converge.CLI.Commands
  ...
  defp run_command([cmd | _rest], _opts) do
    ...
    IO.puts("Run 'converge --help' for usage.")
    System.halt(1)
  end
