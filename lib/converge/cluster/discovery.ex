defmodule Converge.Cluster.Discovery do
  @moduledoc """
  ...
  @mdns_port 5353
  @service_name "_converge._udp.local"
  ...
  defp default_on_discover(peer) do
    ...
    if Process.whereis(Converge.Cluster.Node) do
      Converge.Cluster.Node.add_peer(peer)
    end
  end
end
