defmodule Converge.Consistency do
  @moduledoc """
  Consistency level management for Converge.
  ...
  def quorum_read(namespace, key) do
    ...
    if length(members) < quorum_size do
      ...
      value = Converge.Storage.Store.get(namespace, key)
      {:ok, value}
    else
  ...
  defp query_nodes(members, namespace, key, quorum_size) do
    # Local read
    local_value = Converge.Storage.Store.get(namespace, key)
