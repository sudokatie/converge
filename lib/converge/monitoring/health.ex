defmodule Converge.Monitoring.Health do
  @moduledoc """
  Health check HTTP server for Converge.
  ...
  defp metrics_response do
    body = Converge.Monitoring.Metrics.report()
  ...
  defp check_cluster do
    cond do
      Process.whereis(Converge.Cluster.Node) == nil ->
        {:error, :node_not_running}

      Process.whereis(Converge.Sync.Membership) == nil ->
