defmodule Converge.API do
  @moduledoc """
  Core API implementation for Converge CRDT operations.

  This module contains the implementation of all public API functions.
  The `Converge` module delegates to this module for the public interface.
  """

  alias Converge.CRDT.{PNCounter, LWWRegister, ORSet, LWWMap}
  alias Converge.Storage.Store
  alias Converge.Sync.AntiEntropy
  ...
  def cluster_status do
    ...
    members =
      if Process.whereis(Converge.Sync.Membership) do
        Converge.Sync.Membership.alive_members()
      else
        []
      end
