defmodule Lattice do
  ...
  defdelegate register_set(namespace, key, value), to: Lattice.API

  @doc """
  Gets a register value.
  """
  @spec register_get(namespace(), key()) :: term() | nil
  defdelegate register_get(namespace, key), to: Lattice.API
  ...
  defdelegate set_add(namespace, key, element), to: Lattice.API

  @doc """
  Removes an element from a set.
  """
  @spec set_remove(namespace(), key(), term()) :: :ok | {:error, term()}
  defdelegate set_remove(namespace, key, element), to: Lattice.API

  @doc """
  Checks if a set contains an element.
  """
  @spec set_contains?(namespace(), key(), term()) :: boolean()
  defdelegate set_contains?(namespace, key, element), to: Lattice.API

  @doc """
  Returns all members of a set.
  """
  @spec set_members(namespace(), key()) :: [term()]
  defdelegate set_members(namespace, key), to: Lattice.API
  ...
  defdelegate map_put(namespace, key, field, value), to: Lattice.API

  @doc """
  Deletes a field from a map.
  """
  @spec map_delete(namespace(), key(), term()) :: :ok | {:error, term()}
  defdelegate map_delete(namespace, key, field), to: Lattice.API

  @doc """
  Gets a field value from a map.
  """
  @spec map_get(namespace(), key(), term()) :: term() | nil
  defdelegate map_get(namespace, key, field), to: Lattice.API

  @doc """
  Returns all keys in a map.
  """
  @spec map_keys(namespace(), key()) :: [term()]
  defdelegate map_keys(namespace, key), to: Lattice.API
  ...
  defdelegate create_namespace(name, opts \\ []), to: Lattice.API

  @doc """
  Deletes a namespace and all its data.
  """
  @spec delete_namespace(String.t()) :: :ok | {:error, term()}
  defdelegate delete_namespace(name), to: Lattice.API

  @doc """
  Lists all namespaces.
  """
  @spec list_namespaces() :: [String.t()] | {:error, term()}
  defdelegate list_namespaces(), to: Lattice.API
  ...
  """
  @spec sync_now() :: :ok
  defdelegate sync_now(), to: Lattice.API

  @doc """
  Triggers immediate sync for a specific namespace.
  """
  @spec sync_now(namespace()) :: :ok
  defdelegate sync_now(namespace), to: Lattice.API
  ...
  defdelegate cluster_status(), to: Lattice.API
end
